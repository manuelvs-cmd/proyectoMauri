# Script de Configuración SII para Laravel
# ========================================

Write-Host "🏛️ Configuración del SII (Servicio de Impuestos Internos)" -ForegroundColor Cyan
...
Write-Host "   - Razón social" -ForegroundColor Gray
Write-Host "   - Giro comercial" -ForegroundColor Gray
Write-Host "   - Dirección fiscal" -ForegroundColor Gray
Write-Host ""
Write-Host "2. 🔐 Obtén tu certificado digital del SII:" -ForegroundColor White
...
Write-Host "   - Colócalo en: storage\certificates\" -ForegroundColor Gray
Write-Host ""
Write-Host "3. 📄 Solicita folios CAF del SII:" -ForegroundColor White
Write-Host "   - Facturas Electrónicas (Tipo 33)" -ForegroundColor Gray
Write-Host "   - Coloca archivos .xml en: storage\folios\" -ForegroundColor Gray
Write-Host ""
Write-Host "4. ✅ Verifica la configuración:" -ForegroundColor White
Write-Host "   php artisan sii:check-config" -ForegroundColor Gray
Write-Host ""
Write-Host "5. 🧪 Prueba en ambiente de certificación antes de producción" -ForegroundColor White
Write-Host ""
Write-Host "📖 Para más detalles, consulta: docs\configuracion_sii.md" -ForegroundColor Cyan
Write-Host ""
